...
axios.get('data/misc-group.json').then(function(miscJson) {
...
axios.get('data/temporal-group.json').then(function(datesJson) {
...
axios.get('data/content-category.json').then(function(materialsJson) {
...
axios.get('data/hook-tgm.json').then(function(geographicJson) {
...
timeline = new TL.Timeline('timeline-embed', 'data/timeline.json', { timenav_height: 250 });
